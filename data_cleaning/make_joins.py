...
def make_joins():
    ...
    print('Stock_Location_MarketData')
    Stock_Location_MarketData = Stock_Location.merge(Market_Data, on=[location_key], how='inner', suffixes=('', '_to_delete'))
    Stock_Location_MarketData = delete_column_with_regex(Stock_Location_MarketData, '_to_delete')

    print('Stock_MarketData')
    ...
    print('Stock_Articles_Location_MarketData')
    Stock_Articles_Location_MarketData = Stock_Articles_Location.merge(Market_Data, on=[location_key], how='inner', suffixes=('', '_to_delete'))
    Stock_Articles_Location_MarketData = delete_column_with_regex(Stock_Articles_Location_MarketData, '_to_delete')
    ...
    print('Stock_Articles_Location_MarketData.csv')
    Stock_Articles_Location_MarketData.to_csv(output_path+'Stock_Articles_Location_MarketData.csv',index=False)
